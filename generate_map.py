...
if __name__ == '__main__':
  ...
  # Answer: Denmark (+45)
  to_array('data/letters.csv', './puzzle/2.html', 'UnitedKingdom', 3, 'AIzaSyA5pwIIpyL6u9kuOVs0i_KXitv65toze5c')
  # Answer: Ethiopia (+251)
  to_array('data/reactors.csv', './puzzle/3.html', 'BrazilSwitzerlandArmenia', 2, 'AIzaSyD7L4w39LZ22obci_jIoZ5iT-DoccCtrw8')
  # Answer: Iceland (+354)
  to_array('data/survivor.csv', './puzzle/4.html', 'PanamaFijiPhilippines', 1, 'AIzaSyA0oD5trz09rmpopMLmHfyn-mtTbh3dsqk')
  # Answer: Indonesia (+62)
